...
{//CreateWindow - создает дочернее окно. ќна определ€ет класс, 
//заголовок, стиль окна и (необ€зательно) начальную позицию и размер окна.
//‘ункци€ также определ€ет и окно родител€ или владельца, если таковые имеютс€ и меню окна.
